...
#    {"name": "v37", "file": "...", "color": "#0051FF", "nrun": 1, "type": "OC"},
    {
        "name": "CAR",
        "file": r"26R05MTL_260522_MAC26-01_PER_SQ_R01_L6 1.txt",
        "color": "#BF7300",
    ...
    {
        "name": "Constant JSON",
        "file": r"26R05MTL 11 SQ1 R1 nC4 RED FLAG_ConstantJSON_LTS_Iteration_3.csv",
        "color": "#00A2BF",
    ...
    {
        "name": "Lap 6 Wind",
        "file": r"26R05MTL 11 SQ1 R1 nC4 RED FLAG_Lap6Wind_LTS_Iteration_3.csv",
        "color": "#002DBF",
        #"nlap": 1, # selects the run with the lowest nRun value (best lap) for each plot type
        "type": "DLS",
    },
    {
        "name": "Red Flag",
        "file": r"26R05MTL 11 SQ1 R1 nC4 RED FLAG_LTS_Iteration_3.csv",
        "color": "#6C00BF",
        #"nlap": 1, # selects the run with the lowest nRun value (best lap) for each plot type
        "type": "DLS",
    },
        {
        "name": "Red Flag Strat Wind",
        "file": r"26R05MTL 11 SQ1 R1 nC4 RED FLAG_StratWind_LTS_Iteration_3.csv",
        "color": "#BF0083",
        #"nlap": 1, # selects the run with the lowest nRun value (best lap) for each plot type
        "type": "DLS",
    },
    # {
    #     "name": "CAR",
    #     "file": r"26R05MTL_260522_MAC26-01_PER_SQ_R01_L6 2.txt",
    #     "color": "#BF7300",
    #     #"nrun": 1, # selects the run with the lowest nRun value (best lap) for each plot type
    #     "type": "CAR",
    # },
